...
class TelemetryProcessorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessStream = channel.stream_stream(
                '/telemetry.TelemetryProcessor/ProcessStream',
...
class TelemetryProcessorServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_TelemetryProcessorServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'telemetry.TelemetryProcessor', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('telemetry.TelemetryProcessor', rpc_method_handlers)
